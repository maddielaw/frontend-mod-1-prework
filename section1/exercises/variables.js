...
// ANSWER: I chose a string for the first data type since based on the variable name it would be a
  // first name. For the second data type I chose a boolean since that variable name could
  // be answered with either a true or false statement. And the last variable is a number since
  // that variable name indicates a number of pets.
